...
# PriceTilter Formal Verification Script
# Runs local Certora verification for PriceTilterTWAP contract

set -e

echo "Starting PriceTilter formal verification..."
...
python $CERTORA/certoraRun.py \
    ...
    --smt_timeout 3600 \
    --output_dir reports \
    --msg "PriceTilter verification run"

echo "PriceTilter verification completed!"
